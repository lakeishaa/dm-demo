...
ultra.addEventListener("keyup", (evt) => {
  if (evt.key === "Enter" && ultra.value !== "") {
    ...
    } else if (newJit.lastElementChild.textContent.toLowerCase() === "click") {
      createNewWindows("click", [
        // "https://boniver.withspotify.com/",
        "https://www.dailymail.co.uk/ushome/index.html",
        "https://www.tiktok.com/@dailymail",
        "https://www.youtube.com/@mailsportfootball",
        "https://i.dailymail.co.uk/i/furniture/mobile_apps/android_phone_top.png",
        "https://www.dailymail.co.uk/news/article-13829649/apple-airtag-tracking-parents-children-spouses-cheating.html",
        "https://www.tiktok.com/@dailymail/video/7412599401429896478",
        "https://beautydirectory.s3-ap-southeast-2.amazonaws.com/s3fs-public/styles/long_article/public/articles/daily-mail-australia-header.jpg?itok=cNJUqrrG",
      ]);
    } else if (
